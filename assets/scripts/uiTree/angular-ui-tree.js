...
define(['app'], function (app) {
  'use strict';
    ...
    app.register.constant('treeConfig', {
    ...
    app.register.controller('TreeHandleController', ['$scope', '$element',
    ...
    app.register.controller('TreeNodeController', [
        '$scope', '$element',
        function($scope, $element) {
            this.scope = $scope;
    ...
    app.register.controller('TreeNodesController', [
        '$scope', '$element',
        function($scope, $element) {
            this.scope = $scope;
    ...
    app.register.controller('TreeController', [
        '$scope', '$element',
        function($scope, $element) {
            this.scope = $scope;
    ...
    app.register.directive('uiTreeHandle', [
        'treeConfig',
        function(treeConfig) {
            return {
                require: '^uiTreeNode',
    ...
    app.register.directive('uiTreeNode', [
    ...
    app.register.directive('uiTreeNodes', [
        'treeConfig', '$window',
        function(treeConfig) {
            return {
    ...
    app.register.factory('UiTreeHelper', ['$document', '$window', 'treeConfig',
