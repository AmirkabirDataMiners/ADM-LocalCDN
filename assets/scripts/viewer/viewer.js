    ...
    Viewer.prototype = {
        ...
        print: function () {
            ...
            var html = "<html><head>" +
                    ...
                    "<img src='" + _this.image.currentSrc + "' onload='javascript:window.print();'/>" +
                    "</body>";
            var win = window.open('', '', 'height=' + window.innerHeight + ',width=' + window.innerWidth);
      ...
      '<div class="viewer-container">' +
        ...
        '<div class="viewer-footer">' +
          ...
          '<ul class="viewer-toolbar">' +
            '<li class="viewer-print" data-action="print"><i class="fa fa-print" data-action="print"></i></li>' +
