...
(function(angular) {
    ...
    var ADMdtpConfig = function(ADMdtp, $compileProvider, $provide) {
        ADMdtp.setOptions({isDeviceTouch: ('ontouchstart' in window || navigator.maxTouchPoints)});
        angular.module("ADM-dateTimePicker").register = {
    ...
    return angular.module('ADM-dateTimePicker', [])
        ...
        .config(['ADMdtpProvider', '$compileProvider', '$provide', ADMdtpConfig]);
